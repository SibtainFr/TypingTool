...
**Test your typing speed • Track your progress • Master your skills**

[Download](https://github.com/SibtainFr/TypingTool/releases) • [Report Bug](https://github.com/SibtainFr/TypingTool/issues) • [Request Feature](https://github.com/SibtainFr/TypingTool/issues)
...
## ✨ Features
  ...
  - Hard: Technical terms + symbols
  - Choose from 1 to 5 minutes
  - Live WPM counter
...
3. **Set Duration**
   - Pick test length (1-5 minutes)

4. **Start Typing**
   - Click START and begin typing
   - Text highlights as you type (green = correct, red = error)
